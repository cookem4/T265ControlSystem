...
class Trajectory_Planner:
        ...
        coffsY = []
        coffsZ = []
        #xOffsets = [0,1.1,2.3] # X coordinates of all copters w.r.t the leader [0, 1.2, 0.5]...........marked on mats:[0,1.5,0.82]
        #yOffsets = [0,1.3,0] # Y coordinates of all copters w.r.t the leader   [0, 0, -0.8]..........marked on mats:[0,0,-0.78]
        xOffsets = [0]
        yOffsets = [0]
        ...
        def generate(self, expTime, position, velocity): # position = [[x, y, z],[], ...], velocity = [[xd, yd, zd],[], ...]
                ...
                for i in range (len(self.xOffsets)):
                        ...
                        #FailSafe Check
                        if (abs(self.errors[i][0]) > self.maxPositionErrorTolerance):
